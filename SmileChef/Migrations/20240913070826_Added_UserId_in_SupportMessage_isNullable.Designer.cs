...
namespace SmileChef.Migrations
{
    ...
    [Migration("20240913070826_Added_UserId_in_SupportMessage_isNullable")]
    partial class Added_UserId_in_SupportMessage_isNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmileChef.Models.DbModels.SupportMessage", b =>
                {
                    b.HasOne("ChefApp.Models.DbModels.Chef", "Sender")
                        .WithOne()
                        .HasForeignKey("SmileChef.Models.DbModels.SupportMessage", "ChefId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SmileChef.Models.DbModels.User", "AdminUser")
                        .WithOne()
                        .HasForeignKey("SmileChef.Models.DbModels.SupportMessage", "UserId")
                        .OnDelete(DeleteBehavior.NoAction);
